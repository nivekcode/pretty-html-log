...
export const htmlParsingRules = {
  contains: [
    ...
    },
    {
      ...
      contains: [
        {
          ...
          compiled: true,
          lexemesRe: restoreRegex('/\\w+/gim'),
          beginRe: restoreRegex(
            "/\\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\\b/im"
          ),
      ...
      endRe: restoreRegex('/-->/im'),
      terminator_end: '-->',
      terminators: restoreRegex(
        "/\\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\\b|(?:TODO|FIXME|NOTE|BUG|XXX):|-->/gim"
      )
    },
    {
      begin: '<\\!\\[CDATA\\[',
  ...
  terminators: restoreRegex(
    restoreRegex(
      '/<!DOCTYPE|<!--|<\\!\\[CDATA\\[|<\\?xml|<\\?(php)?|<style(?=\\s|>|$)|<script(?=\\s|>|$)|<\\/?/gim'
    )
  )
};
